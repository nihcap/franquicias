...
@EnableJpaRepositories(FranquiciasApplication.REPOSITORIES_ROUTE)
public class FranquiciasApplication {
    ...
    public static final String REPOSITORIES_ROUTE = "co.com.pragma.franquicias.infrastructure.repositories";
